...
public class AdminAddProductActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        InputProductImage = (ImageView) findViewById(R.id.Select_Prduct_image);
        InputProductName = (EditText) findViewById(R.id.Prodct_name);
        InputProductDescription = (EditText) findViewById(R.id.Prodct_description);
        InputProductPrice = (EditText) findViewById(R.id.Prodct_price);
                ...
                Task<Uri> urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull final Task<Uri> task) {
                        ...
                        if (task.isSuccessful()){
                            ...
                            Toast.makeText(AdminAddProductActivity.this, "Got the image Url", Toast.LENGTH_SHORT).show();
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull final Task<Void> task) {
                        ...
                        if (task.isSuccessful()){
                            ...
                            loadingBar.dismiss();
                            Toast.makeText(AdminAddProductActivity.this, "Product is Upload Successfully", Toast.LENGTH_SHORT).show();
                        }
