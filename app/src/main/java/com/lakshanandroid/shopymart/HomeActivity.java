...
import com.lakshanandroid.shopymart.Model.Products;
import com.lakshanandroid.shopymart.Prevalent.Prevalent;
import com.lakshanandroid.shopymart.ViewHolder.ProductViewHolder;
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Products, ProductViewHolder> adapter =
                new FirebaseRecyclerAdapter<Products, ProductViewHolder>(options) {
                    ...
                    @Override
                    protected void onBindViewHolder(@NonNull final ProductViewHolder holder, final int i, @NonNull final Products products) {
...
//        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_cart) {
            ...
            Intent intent = new Intent(HomeActivity.this, PoductDetailsActivity.class);
